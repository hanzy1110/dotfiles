...
# alias crm_api=sshpass -p "qzNaa+83L?$zaLZ" ssh crm_api

export HELIX_RUNTIME="$HOME/helix/runtime"
export EDITOR="$HOME/.cargo/bin/hx"
# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/bm69/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/bm69/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/bm69/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/bm69/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
alias crm_dev="zellij --layout ${HOME}/layouts/crm.kdl"
alias rto_dev="zellij --layout ${HOME}/layouts/rto.kdl"
alias obs=$HOME/bin/Obsidian-1.1.9.AppImage
alias ll="exa -l"
alias cat="batcat"
